...
public class Constraints_check {
    ...
    public ArrayList<String> check(String courseid, String staffid,int year,String term){
        boolean check=true;
        ...
        try {
            ...
            Logger.getLogger(Constraints_check.class.getName()).log(Level.SEVERE, null, ex);
        }
        return warning;
    }
}
